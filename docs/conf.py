...
project = 'HIE Sensor Management Tool'
copyright = '2018, Teresa Mao, Claire Niederriter, Jaydeep Sambangi'
author = 'Teresa Mao, Claire Niederitter, Jaydeep Sambangi'
...
htmlhelp_basename = 'HIESensorManagementTooldoc'
